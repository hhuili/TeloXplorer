...
def run_telox_methyl(args):
    ...
    telox_asm.run_telox_asm(assembly_input=args.ref_genome,
                            outdir=args.tel_boundary_dir,
    ...
    if args.plot:
        logging.info(f"\n> STEP4: plotting boundary-flanking methylation levels")
        boundary = os.path.join(args.tel_boundary_dir, f'{assembly_name}.chromtel_length.tsv')
...
def telox_methyl_cli():
    ...
    paths = {
        'tel_boundary_dir': "01_telomere_boundary",
